...
strip_all:
	/usr/bin/find . -type f | grep -E "bin/|lib/lib.*[0-9]" | xargs /root/bbndk/host_10_3_1_12/linux/x86/usr/bin/arm-unknown-nto-qnx8.0.0eabi-strip-2.24 2> /dev/null ; /bin/true
